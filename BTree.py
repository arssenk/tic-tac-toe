...
class BTree(BTNode, Board):
    ...
    def _expand_node(self, node, item):
        ...
        if brd.make_clever_random_move(item) == None:
            i_1, j_1 = brd.make_random_move()
            i_2, j_2 = brd.make_random_move()
            if (i_1, j_1) == (i_2, j_2):
                i_2, j_2 = brd.make_random_move()
        elif brd.make_clever_random_move(item) != None:
            i_1, j_1 = i_2, j_2 = brd.make_clever_random_move(item)
            #i_2, j_2 = brd.make_clever_random_move(item)
